/**
 * PostCalibrationSqueezeStep - "Squeeeeeeze!" with circular progress (post-session)
 */
...
export function PostCalibrationSqueezeStep({ state }: WizardStepProps) {
  const { squeezeProgress, maxForce } = state.postCalibration;

  return (
    <div className="wizard-step post-calibration-squeeze-step">
...
export default PostCalibrationSqueezeStep;
